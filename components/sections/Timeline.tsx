  ...
  return (
    <section id="timeline" className="section-padding bg-blueprint">
      <div className="container-narrow">
        {/* Section Header */}
        <div className="mb-16">
          <RevealText delay={0}><p className="tag-mono mb-3">Experience</p></RevealText>
          <RevealText delay={0.1}><h2 className="section-title mb-4">My journey</h2></RevealText>
          <RevealText delay={0.2}>
            <p className="section-subtitle">From education to building real-world solutions.</p>
          </RevealText>
        </div>
            ...
            >
              <div className="flex gap-6">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-xl bg-white border border-neutral-200 flex items-center justify-center z-10 shrink-0">
                ...
                <div className="flex-1 pb-10">
                  ...
                  <h3 className="text-title text-text-primary mb-1">{event.title}</h3>
                  <p className="text-body-sm text-text-muted mb-3">{event.organization}</p>
                  <p className="text-body text-text-secondary mb-4">{event.description}</p>
